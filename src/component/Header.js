...
export const Title = () => {
  return (
    <>
      <div className="logo">
        <Link to="/">
          <img data-testid="logo" src="https://img.icons8.com/color/48/null/just-eat.png" />
        </Link>
      </div>
    </>
  );
  ...
  return (
    <div className="locate-me">
      ...
      <span className="_3HusE">
        Block No-75 Markandeya Nagar, Kumta Naka, Solapur, Maharashtra 413003,
        India
      </span>
        ...
        <div className="nav-item-wrapper ">
          <a className="nav-link" href="/checkout">
            <span className="nav-icon">
              ...
              <span className="cart" data-testid="cart">{cartItems.length}</span>
            </span>
            <span>Cart</span>
          </a>
        </div>
